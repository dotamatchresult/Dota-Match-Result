...
class ZeroDeathWinEvaluator implements ChallengeEvaluator
{
    /**
     * Evaluate a ZERO_DEATH_WIN challenge.
     *
     * Qualifying condition: a participating member must win the match
     * AND have zero deaths. Each qualifying member contributes +1.
     *
     * This is a snapshot challenge — completion is binary (requirement = 1).
     */
